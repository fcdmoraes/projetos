...
tema = 'Trump'
idioma = 'pt'
email = "flavio.moraes@letscode-academy.com"
periodo = 'hora'
...
def send_email(texto, email):
	...
	# destinatario = 'felipe.paiva@letscode-academy.com'
	destinatario = email
...
link = cria_link(tema, False, idioma, periodo)
relatorio = cria_relatorio(link)


send_email(relatorio, email)
